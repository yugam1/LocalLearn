...
class Solution {
    ...
    public List<String> scheduleNotifications(
        ...
        // Hints for Part 1:
        // 1. For each user, calculate notification dates
        // 2. "start" -> account_date
        // 3. "-N" -> end_date - N where end_date = account_date + duration
        // 4. "end" -> end_date
        // 5. Sort all notifications by day, then by name

        // Hints for Part 2:
        // 1. Process changes chronologically
        // 2. On change date: cancel future notifications, print [Changed]
        // 3. Recalculate remaining days: original_end - change_date
        // 4. New end: change_date + remaining_days
        // 5. Schedule new notifications with new plan

        // Hints for Part 3:
        // 1. Identify renewal vs plan change (check for "extension" key)
        // 2. On renewal: extend end_date by extension days
        // 3. Cancel and reschedule future notifications
...
class Judge {
    ...
    private static final boolean CHECK_FULL = false; // true = all tests, false = basic only
